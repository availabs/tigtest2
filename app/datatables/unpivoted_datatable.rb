class UnpivotedDatatable < AjaxDatatablesRails::Base
  ...
  # https://github.com/jbox-web/ajax-datatables-rails/blob/53b2fdc8b757b6238cd900f0066605ead93fae6c/lib/ajax-datatables-rails/extensions/simple_paginator.rb#L7-L9
