...
CsLeaflet.Leaflet = {
    ...
    init: function(mapId, options) {
        ...
        var mapOptions = {
            zoomControl: options.show_default_zoom_control, 
            scrollWheelZoom: options.scroll_wheel_zoom, 
            zoomAnimation: options.zoom_animation
        };
        if(typeof(options.min_zoom) === 'number') {
            mapOptions.minZoom = options.min_zoom;
        }
         if(typeof(options.max_zoom) === 'number') {
            mapOptions.maxZoom = options.max_zoom;
        }
        
        this.LMmap = L.map(mapId, mapOptions);
        //this.addZoomControl();
        ...
        } else if (options.tile_provider == 'CLOUDMADE') {
...
//register prototype
CsLeaflet.Leaflet.prototype = CsLeaflet.Leaflet;